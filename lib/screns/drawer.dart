...
import 'package:taxiapp/screns/Profile%20and%20choice%20cab/personal_details_cubit.dart';
...
class CustomDrawer extends StatefulWidget {
  ...
  CustomDrawer({this.fname,this.lname,this.number,this.email,this.onClick,this.accesstoken,this.id,this.username,this.longitude,this.latitude ,this.onClickUpdate});
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      var args =await {
        "from": 'login',
        "code": 'ffrr',
        "user_id": widget.id.toString().trim(),//Response.success.userId,
        "token": widget.accesstoken.toString().trim(),
        "latitude": widget.latitude.toString().trim(),
        "longitude": widget.longitude.toString().trim()
      };
      // print(loginResponse.success.token);
      NavigationService().navigationKey.currentState!.pushNamed(nearby, arguments: args);
          } //editName?
        )
