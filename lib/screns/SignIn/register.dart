...
class _RegisterState extends State<Register> {
  ...
  TextEditingController? _controllerusername_dlnumber = TextEditingController();
  TextEditingController? _controller_numberplate = TextEditingController();
    ...
    return Scaffold(
      ...
      SingleChildScrollView(child:Container(
        ...
        /*  SizedBox(height: 30,),
          ...
          SizedBox(height: 30,),
          Text('Vehicle Number Plate',style: TextStyle(color: Colors.grey),),
          SizedBox(height: 10,),
          Material(
            elevation: 5,
            shadowColor: Color(0xffF5F5F5),
            child: TextFormField(
              controller: _controller_numberplate!,
              //obscureText: true,
              autofocus: false,
              decoration: InputDecoration(
                //icon: new Icon(Icons.lock, color: Color(0xff224597)),
                  hintText: 'Enter Cab Number',
          ...
          SizedBox(height: 20,),
          Text('Driving Licene Number',style: TextStyle(color: Colors.grey),),
          SizedBox(height: 10,),
          Material(
            elevation: 5,
            shadowColor: Color(0xffF5F5F5),
            child: TextFormField(
              controller: _controllerusername_dlnumber!,
              //obscureText: true,
              autofocus: false,
              decoration: InputDecoration(
                //icon: new Icon(Icons.lock, color: Color(0xff224597)),
          ...
          return Container(height:450,padding:EdgeInsets.symmetric(horizontal: 20),child:Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              SizedBox(height: 30,),
             // SizedBox(height: 10,),
              Material(
              ...
              Container(height: 55,width:MediaQuery. of(context). size. width ,color:kPrimaryColor,child:FlatButton(onPressed: () async {
                if (isValidate()) {
                  ...
                  widget.onClick({
                    ...
                    'device_id': deviceId,
                    'driving_licence': _controllerusername_dlnumber!.text,
                    'taxi_no': _controller_numberplate!.text
