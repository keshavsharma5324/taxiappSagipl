class Constants {
  ...
  static String register = 'register-driver';

  static String uploadProfilePic = 'update-profile-picture';
  static String updateProfile = 'auth/user-register';
  static String getProfile = 'profile-driver?user_id=';
  static String getBookingRequest = 'fetch-request';
  static String acceptBookingRequest = 'accept-cab';
  static String declineBookingRequest = 'declined-cab';
  static String startRide= 'ride-start';
  static String endRide = 'ride-end';
  static String profileDetail = getProfile;
  static String profileUpdate = 'profile-update-driver?user_id=';

  static String changePassword = 'add-password';

  static String getTaxiList = 'taxi-type-list';

  static String login = 'login-driver';
  ...
  static String getNearByDrivers = 'search-nearby-driver';
